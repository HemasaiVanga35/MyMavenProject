...
public class A7_INR_optionsvalidation {
  ...
  public void options() {
	  ...
	  System.out.println(allvalues.get(14).getText());
		 
	 //printing all values from A to Z (starting to ending)
	...
	//checking comparison with equalIgnoreCase or
	//contains(validationProspective)
	 if (allvalues.get(i).getText().equalsIgnoreCase("30"))
	 {
